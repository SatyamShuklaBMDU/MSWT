...
// https://laravel.com/docs/9.x/authentication#the-authenticatable-contract    // https://laravel.com/api/9.x/Illuminate/Contracts/Auth/Authenticatable.html
...
class Admin extends Authenticatable
{
    ...
    protected $guarded = []; // https://laravel.com/docs/9.x/eloquent#mass-assignment
    ...
    { // relationship between `admins` and `vendors_business_details` table
        return $this->belongsTo('App\Models\VendorsBusinessDetail', 'vendor_id'); // 'vendor_id' is the foreign key of the `admins` table
    }

    public function vendorBank()
    { // relationship between `admins` and `vendors_bank_details` table
