            ...
            <div class="card">
               <div class="card-body ">
                  ...
                  <div class="sticky-form sticky">
                     <div class="col-md-12 ">
                        <form class="notification-form shadow rounded" method="get" action="{{url('admin/users')}}">
                                       ...
                                       <div class="row mb" style="margin-bottom: 30px;">
                                          ...
                                          <div class="col-sm-3 end-date">
                                               ...
                                               <div class="input-group date d-flex" id="datepicker1">
                                                   <input type="date" class="form-control" name="start" id="startdate" value="" placeholder="dd-mm-yyyy" />
                                               </div>
                                           </div>
                                           <div class="col-sm-3 end-date">
                                               <p class="text-dark"><strong>Date From:</strong></p>
                                               <div class="input-group date d-flex" id="datepicker2">
                                                   <input type="date" class="form-control" name="end" id="enddate" value="" placeholder="dd-mm-yyyy" />
                                               </div>
                                           </div>
                     ...
                     <table id="users" class="table table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{ $user['country'] }}</td>
                              <td>
                                 <select class=" form-control"  style="width: 150px; border: none;"  onchange="changeStatus(this.value, {{ $user['id'] }})">
                                    @if ($user['status'] == 1)
                              ...
                              <!-- <td>
                                 @if ($user['status'] == 1)
                                     ...
                                     @endif
                                  @if ($user['status'] == 0) {{-- if the admin status is inactive --}}
                                     <a class="updateUserStatus" id="user-{{ $user['id'] }}" user_id="{{ $user['id'] }}" href="javascript:void(0)"> {{-- Using HTML Custom Attributes. Check admin/js/custom.js --}}
