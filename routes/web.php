...
Route::prefix('')->namespace('App\Http\Controllers\Admin')->group(function() {
    ...
    Route::post('/login', 'AdminController@login'); // match() method is used to use more than one HTTP request method for the same route, so GET for rendering the login.php page, and POST for the login.php page <form> submission (e.g. GET and POST)    // Matches the '/admin/dashboard' URL (i.e. http://127.0.0.1:8000/admin/dashboard)
    Route::group(['middleware' => ['admin']], function() { // using our 'admin' guard (which we created in auth.php)
        ...
        // Admin Manage Route 
        Route::get('all-manage','AdminController@showallAdminPage');
        Route::match(['get', 'post'],'edit-manage/{id}','AdminController@editAdminPage');
        Route::match(['get', 'post'], '/add-manage', 'AdminController@showAdminPage');
        Route::post('update-user-admin-status', 'AdminController@updateUserAdminStatus'); // Update Products Status using AJAX in products.blade.php
        ...
        Route::post('section_filter', 'SectionController@sectionsFilter');
    ...
    // Route::get('/product/{id}', 'ProductsController@detail');
        ...
        Route::post('filter-users', 'UserController@filterUser'); // Render admin/users/users.blade.php page in the Admin Panel
        ...
        Route::post('/changeStatuss', 'UserController@changeStatuss');
        // Orders
        ...
        Route::get('change-status-subscribers', 'NewsletterController@changeStatusSubscribers');
